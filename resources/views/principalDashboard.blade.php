        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 xl:grid-cols-4 mb-6">
            ...
            <div
                ...
                <div class="mt-5 flex items-end justify-between">
                    ...
                    <span
                        class="flex items-center gap-1 rounded-full bg-success-50 px-2 py-0.5 text-sm font-medium text-success-600 dark:bg-success-500/15 dark:text-success-500">
            ...
            <div
                ...
                <div class="mt-5 flex items-end justify-between">
                    <div>
                        ...
                        <h4 class="mt-2 text-3xl font-bold text-gray-800 dark:text-white/90">{{ $maintenanceBuses }}
                        </h4>
                    </div>
                    <span
                        class="flex items-center gap-1 rounded-full bg-warning-50 px-2 py-0.5 text-sm font-medium text-warning-600 dark:bg-warning-500/15 dark:text-warning-500">
                ...
                <div
                    ...
                    @if ($totalBuses > 0)
                        <div class="mt-6 flex h-3 w-full overflow-hidden rounded-full bg-gray-100 dark:bg-gray-800">
                            @if ($activeBuses > 0)
                                <div class="bg-success-500" style="width: {{ $bar($activeBuses, $totalBuses) }}%">
                                </div>
                            @endif
                            @if ($maintenanceBuses > 0)
                                <div class="bg-warning-500" style="width: {{ $bar($maintenanceBuses, $totalBuses) }}%">
                                </div>
                            @endif
                            @if ($inactiveBuses > 0)
                                    ...
                                    @forelse ($fleet as $bus)
                                        <tr class="text-gray-700 dark:text-gray-200">
                                            ...
                                            <td class="py-3.5">
                                                ...
                                                @else
                                                    <span class="text-theme-xs text-gray-400 dark:text-gray-500">No
                                                        driver</span>
                                                @endif
                                            </td>
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                @forelse ($upcomingRoutes as $route)
                                    <tr class="text-gray-700 dark:text-gray-200">
                                        ...
                                        <td class="py-3.5 text-theme-sm">
                                            {{ $route->activeTrip?->bus?->drivers?->first()?->full_name ?? 'Not assigned' }}
                                        </td>
                    ...
                    <div class="mt-5 min-h-0 flex-1 overflow-y-auto custom-scrollbar pr-1">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/[0.03]">
                                ...
                                <span class="text-theme-xs mt-1 block text-gray-500 dark:text-gray-400">of fleet
                                    active</span>
                            </div>
                        </div>
