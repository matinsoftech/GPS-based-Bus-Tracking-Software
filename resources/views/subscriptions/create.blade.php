            ...
            <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="school_id" name="school_id" required
                                ...
                                @foreach ($schools as $school)
                                    <option value="{{ $school->id }}" {{ (string) old('school_id', $selectedSchool) === (string) $school->id ? 'selected' : '' }}>
                                        {{ $school->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                    ...
                    <div class="mt-4 flex gap-4">
                        ...
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="radio" name="billing_cycle" value="yearly" {{ old('billing_cycle') === 'yearly' ? 'checked' : '' }}
                                class="h-4 w-4 border-gray-300 text-brand-500 focus:ring-brand-500">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                    ...
                    <div class="mt-4 flex gap-4">
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="radio" name="status" value="trialing" {{ old('status', 'trialing') === 'trialing' ? 'checked' : '' }}
                                class="h-4 w-4 border-gray-300 text-brand-500 focus:ring-brand-500">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Trialing</span>
                        </label>
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-4 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
