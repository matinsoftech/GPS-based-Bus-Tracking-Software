<x-app-layout page="school-management">
    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
        ...
        <div class="mb-6">
            @php
                $schoolTabs = [
                    ['key' => 'overview', 'label' => 'Overview', 'url' => route('schools.show', $school), 'icon' => 'squares-2x2'],
                    ['key' => 'principal', 'label' => 'Principal', 'url' => route('schools.show', [$school, 'tab' => 'principal']), 'icon' => 'identification', 'count' => $totalSchoolAdmins],
                    ['key' => 'students', 'label' => 'Students', 'url' => route('schools.show', [$school, 'tab' => 'students']), 'icon' => 'academic-cap', 'count' => $totalStudents],
                    ['key' => 'drivers', 'label' => 'Drivers', 'url' => route('schools.show', [$school, 'tab' => 'drivers']), 'icon' => 'user-circle', 'count' => $totalDrivers],
                    ['key' => 'parents', 'label' => 'Parents', 'url' => route('schools.show', [$school, 'tab' => 'parents']), 'icon' => 'users', 'count' => $totalParents],
                    ['key' => 'buses', 'label' => 'Buses', 'url' => route('schools.show', [$school, 'tab' => 'buses']), 'icon' => 'truck', 'count' => $totalBuses],
                    ['key' => 'routes', 'label' => 'Routes', 'url' => route('schools.show', [$school, 'tab' => 'routes']), 'icon' => 'map', 'count' => $totalRoutes],
                    ['key' => 'subscriptions', 'label' => 'Subscriptions', 'url' => route('schools.show', [$school, 'tab' => 'subscriptions']), 'icon' => 'credit-card', 'count' => $totalSubscriptions],
                    ['key' => 'invoices', 'label' => 'Invoices', 'url' => route('schools.show', [$school, 'tab' => 'invoices']), 'icon' => 'document-text', 'count' => $totalInvoices],
        ...
        <div class="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $schoolAdmins->total() }} admin{{ $schoolAdmins->total() === 1 ? '' : 's' }}</span>
            </div>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $students->total() }} student{{ $students->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $drivers->total() }} driver{{ $drivers->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $parents->total() }} parent{{ $parents->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $buses->total() }} bus{{ $buses->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $routes->total() }} route{{ $routes->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($routes as $route)
                            <tr class="text-gray-700 dark:text-gray-200">
                                <td class="px-5 py-3">
                                    <a href="{{ route('routes.show', $route) }}" class="font-medium text-brand-600 hover:underline dark:text-brand-400">
                                        {{ $route->name }}
                                    </a>
                                </td>
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $subscriptions->total() }} subscription{{ $subscriptions->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($subscriptions as $subscription)
                            ...
                            <tr class="text-gray-700 dark:text-gray-200">
                                ...
                                <td class="px-5 py-3">
                                    <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-medium {{ $subStatusColors[$subscription->status] ?? 'bg-gray-100 text-gray-700 dark:bg-gray-900/20 dark:text-gray-400' }}">
                                        {{ ucfirst(str_replace('_', ' ', $subscription->status)) }}
                                    </span>
                                </td>
                                <td class="px-5 py-3">{{ $subscription->created_at?->format('M d, Y') ?? '—' }}</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="5" class="px-5 py-10 text-center text-gray-500 dark:text-gray-400">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $invoices->total() }} invoice{{ $invoices->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($invoices as $invoice)
                            ...
                            <tr class="text-gray-700 dark:text-gray-200">
                                ...
                                <td class="px-5 py-3">
                                    <span class="inline-flex rounded-full px-2.5 py-1 text-xs font-medium {{ $invStatusColors[$invoice->statusLabel()] ?? 'bg-gray-100 text-gray-700 dark:bg-gray-900/20 dark:text-gray-400' }}">
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $gpsDevices->total() }} device{{ $gpsDevices->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
                            ...
                            <tr class="text-gray-700 dark:text-gray-200">
                                ...
                                <td class="px-5 py-3">
                                    @if ($device->status === 'active')
                                        <span class="rounded-full bg-green-100 px-2 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/20 dark:text-green-400">Active</span>
                                    @else
                                        <span class="rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-600 dark:bg-gray-800 dark:text-gray-400">{{ $device->status ?? '—' }}</span>
                                    @endif
                                </td>
                            </tr>
                        @empty
        ...
        <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">{{ $routeStops->total() }} stop{{ $routeStops->total() === 1 ? '' : 's' }}</span>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="border-b border-gray-200 dark:border-gray-800">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse ($routeStops as $stop)
                            <tr class="text-gray-700 dark:text-gray-200">
                                <td class="px-5 py-3 font-medium text-gray-900 dark:text-white">{{ $stop->name }}</td>
                                <td class="px-5 py-3">
                                    <a href="{{ route('routes.show', $stop->route) }}" class="text-brand-600 hover:underline dark:text-brand-400">
                                        {{ $stop->route?->name ?? '—' }}
                                    </a>
                                </td>
