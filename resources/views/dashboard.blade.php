        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 xl:grid-cols-4">
            <div class="flex min-h-[150px] flex-col rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div class="mt-5 flex items-end justify-between">
                    ...
                    <a href="{{ route('schools.index') }}" class="text-theme-xs font-medium text-brand-500 hover:text-brand-600">View all</a>
                </div>
            </div>
            ...
            <div class="flex min-h-[150px] flex-col rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div class="mt-5 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-theme-xs mt-1 block text-gray-400 dark:text-gray-500">{{ $activeStudents }} active</span>
                    </div>
                    <a href="{{ route('students.index') }}" class="text-theme-xs font-medium text-brand-500 hover:text-brand-600">View all</a>
                </div>
            </div>
            ...
            <div class="flex min-h-[150px] flex-col rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                ...
                <div class="mt-5 flex items-end justify-between">
                    <div>
                        ...
                        <span class="text-theme-xs mt-1 block text-gray-400 dark:text-gray-500">{{ $activeDrivers }} active</span>
                    </div>
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @forelse ($fleet as $bus)
                                        <tr class="text-gray-700 dark:text-gray-200">
                                            ...
                                            <td class="py-3.5 text-theme-xs text-gray-500 dark:text-gray-400">{{ $bus->school?->name ?? '—' }}</td>
                ...
                <div class="flex h-full min-h-[460px] flex-col rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                    ...
                    <div class="mt-5 min-h-0 flex-1 space-y-4 overflow-y-auto custom-scrollbar pr-1">
                        ...
                        @forelse ($unassignedBuses as $bus)
                            <div class="flex items-start gap-3 rounded-xl border border-gray-100 bg-gray-50/50 p-3 dark:border-gray-800 dark:bg-white/[0.03]">
                                <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-300">
                                    <svg class="fill-current" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C7.17157 2 6.5 2.67157 6.5 3.5V4.25H9.5V3.5C9.5 2.67157 8.82843 2 8 2ZM11 4.25V3.5C11 1.84315 9.65685 0.5 8 0.5C6.34315 0.5 5 1.84315 5 3.5V4.25H4.25C3.00736 4.25 2 5.25736 2 6.5V12.5C2 13.7426 3.00736 14.75 4.25 14.75H11.75C12.9926 14.75 14 13.7426 14 12.5V6.5C14 5.25736 12.9926 4.25 11.75 4.25H11ZM3.5 6.5C3.5 6.08579 3.83579 5.75 4.25 5.75H11.75C12.1642 5.75 12.5 6.08579 12.5 6.5V12.5C12.5 12.9142 12.1642 13.25 11.75 13.25H4.25C3.83579 13.25 3.5 12.9142 3.5 12.5V6.5Z" fill=""/>
                                    </svg>
                                </span>
        ...
        <div class="mt-6 grid grid-cols-12 gap-4 md:gap-6">
            <div class="col-span-12 xl:col-span-7">
                <div class="flex h-full min-h-[460px] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('schools.index') }}" class="text-theme-sm font-medium text-brand-500 hover:text-brand-600">View all</a>
                    </div>
                        ...
                        <table class="w-full text-left text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                @forelse ($schools as $entry)
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-200">
                                        <td class="py-3.5">
                                            <a href="{{ route('schools.show', $school) }}" class="font-medium text-gray-800 hover:text-brand-500 dark:text-white/90">
                                                {{ $school->name }}
                                            </a>
                                            <p class="text-theme-xs text-gray-500 dark:text-gray-400">{{ $school->code }}</p>
                                        </td>
                                        <td class="py-3.5">
                                        ...
                                        <td class="py-3.5 text-right text-theme-sm">{{ $entry['routes'] }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5" class="py-8 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <div class="col-span-12 xl:col-span-5">
                <div class="flex h-full min-h-[460px] flex-col rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">System Snapshot</h3>
                            <p class="mt-1 text-theme-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div class="mt-5 min-h-0 flex-1 overflow-y-auto custom-scrollbar pr-1">
                        ...
                        <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/[0.03]">
                            ...
                            <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $activeRoutes }} <span class="text-theme-sm font-normal text-gray-400">/ {{ $totalRoutes }}</span></h4>
                        ...
                        <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/[0.03]">
                            ...
                            <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $totalRouteStops }}</h4>
                            <a href="{{ route('routes.index') }}" class="text-theme-xs mt-1 inline-block font-medium text-brand-500 hover:text-brand-600">View all</a>
                        </div>
                        <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/[0.03]">
                            <span class="text-theme-sm text-gray-500 dark:text-gray-400">Parents</span>
                            <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $totalParents }}</h4>
                            <a href="{{ route('parents.index') }}" class="text-theme-xs mt-1 inline-block font-medium text-brand-500 hover:text-brand-600">View all</a>
                        </div>
                        <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/[0.03]">
                            <span class="text-theme-sm text-gray-500 dark:text-gray-400">School Admins</span>
                            <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $totalSchoolAdmins }}</h4>
                            <a href="{{ route('school-admins.index') }}" class="text-theme-xs mt-1 inline-block font-medium text-brand-500 hover:text-brand-600">View all</a>
                        </div>
                        <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/[0.03]">
                            <span class="text-theme-sm text-gray-500 dark:text-gray-400">Buses Online</span>
                            <h4 class="mt-1 text-2xl font-bold text-emerald-600 dark:text-emerald-400">{{ $onlineBuses }}</h4>
                        </div>
                        <div class="rounded-xl bg-gray-50 p-4 dark:bg-white/[0.03]">
                            <span class="text-theme-sm text-gray-500 dark:text-gray-400">Checked In Today</span>
                            <h4 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white/90">{{ $todayCheckedIn }} <span class="text-theme-sm font-normal text-gray-400">/ {{ $todayAttendance }}</span></h4>
                            <a href="{{ route('attendance.index') }}" class="text-theme-xs mt-1 inline-block font-medium text-brand-500 hover:text-brand-600">View all</a>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                        ...
                        <div class="mt-3 grid grid-cols-2 gap-3">
                            <a href="{{ route('schools.create') }}" class="rounded-lg bg-brand-500 px-4 py-2.5 text-center text-theme-sm font-medium text-white hover:bg-brand-600">
                                Add School
                            </a>
                            <a href="{{ route('buses.create') }}" class="rounded-lg border border-gray-300 px-4 py-2.5 text-center text-theme-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                Add Bus
                            </a>
                            ...
                            <a href="{{ route('attendance.index') }}" class="rounded-lg border border-gray-300 px-4 py-2.5 text-center text-theme-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-white/[0.03]">
                                Attendance
                            </a>
                        </div>
                    </div>
