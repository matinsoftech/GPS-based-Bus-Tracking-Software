    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                <div class="relative" x-data="{ dropdownOpen: false, unreadCount: {{ $headerUnreadCount }} }" x-init="setInterval(() => {
                    ...
                    <button
                        ...
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M5.25 9a6.75 6.75 0 0 1 13.5 0v.75c0 2.123.8 4.057 2.118 5.52a.75.75 0 0 1-.297 1.206 24.585 24.585 0 0 1-4.831 1.244 3.75 3.75 0 1 1-7.48 0 24.585 24.585 0 0 1-4.831-1.244.75.75 0 0 1-.298-1.205A8.217 8.217 0 0 0 5.25 9.75V9Zm4.502 8.9a2.25 2.25 0 1 0 4.496 0 25.057 25.057 0 0 1-4.496 0Z"
                                fill="#FFC83D" stroke="#B87A0E" stroke-width="0.3" />
                        </svg>
                        ...
                        <ul class="flex h-auto flex-col overflow-hidden overflow-y-auto custom-scrollbar">
                                ...
                                <li>
                                    <a href="{{ route('notifications.index') }}"
                                        ...
                                        <span class="block min-w-0 flex-1">
                                            ...
                                            <span
                                                class="text-theme-xs block truncate text-gray-500 dark:text-gray-400">
                                                {{ $notification->data['message'] ?? '' }}
                                            </span>

                                            <span
                                                class="text-theme-xs mt-1 flex items-center gap-2 text-gray-500 dark:text-gray-400">
                                                <span>{{ $notification->created_at->diffForHumans() }}</span>
                                                @if ($unread)
                                                    <span class="h-1 w-1 rounded-full bg-brand-500"></span>
                                                    <span
                                                        class="font-semibold text-brand-600 dark:text-brand-400">New</span>
                                                @endif
                                            </span>
                                        </span>
                                    </a>
                            ...
                            @empty
                                <li class="flex flex-col items-center justify-center gap-2 py-12 text-center">
                                    <span
                                        class="flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 text-gray-400 dark:bg-gray-800 dark:text-gray-500">
