@php
    ...
    $superAdminMenu = [
        ...
        [
            ...
            'items' => [
                ...
                ['key' => 'driver-management', 'label' => 'Driver', 'route' => 'drivers.index', 'active' => 'driver-management', 'icon' => 'heroicon-o-user-group', 'permission' => 'driver.view', 'dropdown' => null],
    ...
    $principalMenu = [
        [
            'title' => 'Dashboard',
            'items' => [
                ['key' => 'dashboard', 'label' => 'Dashboard', 'route' => 'principal.dashboard', 'active' => ['overview', 'dashboard'], 'icon' => 'heroicon-o-home', 'permission' => null, 'dropdown' => null],
            ],
        ],
        [
            'title' => 'Management',
