                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex items-start justify-between gap-2">
                                <div class="min-w-0">
                                    <p class="truncate font-medium text-gray-900 dark:text-white">
                                        {{ $student->full_name }}</p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">{{ $student->admission_no }}
                                    </p>
                                </div>
                                @if ($student->is_active)
                                    <span
                            ...
                            <dl class="mt-3 grid grid-cols-2 gap-x-3 gap-y-1.5 text-xs">
                                <div>
                                    <dt class="text-gray-400 dark:text-gray-500">Grade</dt>
                                ...
                                <div>
                                    ...
                                    <dd class="text-gray-700 dark:text-gray-200">{{ $student->school->name ?? '—' }}
                                    </dd>
                                </div>
                                <div>
