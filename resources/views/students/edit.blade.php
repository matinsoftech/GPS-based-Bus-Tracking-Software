<x-app-layout page="student-management">
    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Student</h1>
            <a
                    ...
                    <div>
                        ...
                        @if ($student->photo)
                            <div class="mb-2 flex items-center gap-3">
                                ...
                                >
                                <span class="text-xs text-gray-500 dark:text-gray-400">Current photo</span>
                            </div>
                        @endif
                        <input
                            type="file"
                    ...
                    @if (isset($school) && $school)
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                The student is assigned to your school.
                            </p>
                        </div>
                    @else
                        <div>
                            ...
                            >
                                ...
                                @foreach ($schools as $school)
                                    <option value="{{ $school->id }}" @selected(old('school_id', $student->school_id) == $school->id)>{{ $school->name }}</option>
                                @endforeach
                            </select>
                            @error('school_id')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach ($parents as $parent)
                                <option value="{{ $parent->id }}" data-school-id="{{ $parent->school_id }}" @selected(old('parent_id', $student->parent_id) == $parent->id)>{{ $parent->user->name }}</option>
                            @endforeach
                        </select>
                        @error('parent_id')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        @else
                            ...
                            >
                                ...
                                @foreach ($routes as $route)
                                    <option value="{{ $route->id }}" @selected(old('route_id', $student->route_id) == $route->id)>{{ $route->name }}@if ($route->route_code) ({{ $route->route_code }})@endif</option>
                                @endforeach
                            </select>
                            @error('route_id')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('pickup_location', $student->pickup_location) }}"
                            required
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="drop_location"
                            name="drop_location"
                            value="{{ old('drop_location', $student->drop_location) }}"
                            required
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        >
                        @error('drop_location')
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('pickup_latitude', $student->pickup_latitude) }}"
                            step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('pickup_longitude', $student->pickup_longitude) }}"
                            step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="drop_latitude"
                            name="drop_latitude"
                            value="{{ old('drop_latitude', $student->drop_latitude) }}"
                            step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        >
                        @error('drop_latitude')
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="drop_longitude"
                            name="drop_longitude"
                            value="{{ old('drop_longitude', $student->drop_longitude) }}"
                            step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                        >
