                        ...
                        <select id="parent_id" name="parent_id" required
                            ...
                            @foreach ($parents as $parent)
                                <option value="{{ $parent->id }}" data-school-id="{{ $parent->school_id }}"
                                    @selected(old('parent_id', $student->parent_id) == $parent->id)>{{ $parent->user->name }}</option>
                            @endforeach
                        </select>
                        @error('parent_id')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        @else
                            <select id="route_id" name="route_id"
                                ...
                                @foreach ($routes as $route)
                                    <option value="{{ $route->id }}" @selected(old('route_id', $student->route_id) == $route->id)>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="pickup_location" name="pickup_location"
                            value="{{ old('pickup_location', $student->pickup_location) }}" required
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="text" id="drop_location" name="drop_location"
                            value="{{ old('drop_location', $student->drop_location) }}" required
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        @error('drop_location')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="pickup_latitude" name="pickup_latitude"
                            value="{{ old('pickup_latitude', $student->pickup_latitude) }}" step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="text" id="pickup_longitude" name="pickup_longitude"
                            value="{{ old('pickup_longitude', $student->pickup_longitude) }}" step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                    ...
                    <div>
                        ...
                        <input type="text" id="drop_latitude" name="drop_latitude"
                            value="{{ old('drop_latitude', $student->drop_latitude) }}" step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        @error('drop_latitude')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="text" id="drop_longitude" name="drop_longitude"
                            value="{{ old('drop_longitude', $student->drop_longitude) }}" step="any"
                            class="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
