<x-app-layout page="live-tracking">
    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
        <div class="mb-6 flex flex-wrap items-center justify-between gap-3">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Live Tracking</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Real-time GPS position of your assigned bus{{ $buses->count() === 1 ? '' : 'es' }}, refreshed directly from the live GPS provider.
                </p>
            </div>
        ...
        @else
            @include('partials.fleet-map', [
                ...
                'fleetMapSubtitle' => 'Live GPS position of your assigned bus, route path, and stops.',
            ])
            ...
            <div class="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">My Bus Telemetry</h2>
                </div>
                    ...
                    <table class="w-full text-left text-sm">
                        <thead class="border-b border-gray-200 dark:border-gray-800">
                            <tr class="text-gray-500 dark:text-gray-400">
                                ...
                                <th class="px-5 py-3 font-medium">Next Stop</th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            @forelse ($fleetMap['buses'] as $bus)
                                ...
                                >
                                    ...
                                    <td class="px-5 py-3">{{ $bus['next_stop'] ?? '—' }}</td>
                                    <td class="px-5 py-3">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-5 py-10 text-center text-gray-500 dark:text-gray-400">
                                        No telemetry available right now.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
