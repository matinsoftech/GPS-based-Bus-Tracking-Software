<x-app-layout page="plans">
    <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Edit Plan</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Update plan details, limits, and features.
                </p>
            </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="number" id="monthly_price" name="monthly_price" value="{{ old('monthly_price', $plan->monthly_price) }}" required
                                min="0" step="0.01" placeholder="0.00"
                                class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        </div>
                        <div>
                            <label for="yearly_price" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Yearly Price (₹)</label>
                            <input type="number" id="yearly_price" name="yearly_price" value="{{ old('yearly_price', $plan->yearly_price) }}" required
                                min="0" step="0.01" placeholder="0.00"
                                class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        </div>
                    </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
                        <div>
                            ...
                            <input type="number" id="max_buses" name="max_buses" value="{{ old('max_buses', $plan->max_buses) }}"
                        ...
                        <div>
                            ...
                            <input type="number" id="max_students" name="max_students" value="{{ old('max_students', $plan->max_students) }}"
                                min="0" placeholder="Unlimited"
                                class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        </div>
                        <div>
                            <label for="max_parents" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Max Parents</label>
                            <input type="number" id="max_parents" name="max_parents" value="{{ old('max_parents', $plan->max_parents) }}"
                                min="0" placeholder="Unlimited"
                                class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        </div>
                        <div>
                            <label for="max_drivers" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Max Drivers</label>
                            <input type="number" id="max_drivers" name="max_drivers" value="{{ old('max_drivers', $plan->max_drivers) }}"
                                min="0" placeholder="Unlimited"
                                class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        </div>
                        <div>
                            <label for="max_routes" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Max Routes</label>
                            <input type="number" id="max_routes" name="max_routes" value="{{ old('max_routes', $plan->max_routes) }}"
                                min="0" placeholder="Unlimited"
                                class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        </div>
                        <div>
                            <label for="max_devices" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Max Devices</label>
                            <input type="number" id="max_devices" name="max_devices" value="{{ old('max_devices', $plan->max_devices) }}"
                                min="0" placeholder="Unlimited"
                                class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 text-sm text-gray-900 focus:border-brand-500 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white">
                        </div>
                    </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="checkbox" name="feature_live_tracking" value="1" {{ ($features['live_tracking'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Live Tracking</span>
                        </label>
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="checkbox" name="feature_parent_app" value="1" {{ ($features['parent_app'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Parent App</span>
                        </label>
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="checkbox" name="feature_notifications" value="1" {{ ($features['notifications'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Notifications</span>
                        </label>
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="checkbox" name="feature_attendance" value="1" {{ ($features['attendance'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Attendance</span>
                        </label>
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="checkbox" name="feature_reports" value="1" {{ ($features['reports'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                            <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Reports</span>
                        </label>
                        <label class="flex cursor-pointer items-center gap-2 rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-700 dark:bg-white/[0.03]">
                            <input type="checkbox" name="feature_analytics" value="1" {{ ($features['analytics'] ?? false) ? 'checked' : '' }}
                                class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
